    ...
    <header class="flex items-center justify-between border-b pb-4">
        <div>
            ...
            <p class="text-sm text-slate-500 mt-1">
                シナリオを選んで通常レジ操作トレーニングを開始します。（TRN-N-01）
            </p>
        </div>
    ...
    <section class="space-y-4">
        @forelse($scenarios as $scenario)
            <form method="POST"
                  ...
                  class="border border-slate-200 rounded-lg p-4 flex items-center justify-between hover:border-indigo-500 transition">
                @csrf
                <div>
