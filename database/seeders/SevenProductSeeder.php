...
class SevenProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $rows = [
            ...
            ['でかい揚げ鶏', 232, 'ホットスナック', '大型サイズの揚げ鶏。全国販売。262kcal'],
            ...
            ['ＢＩＧポークフランク', 198, 'ホットスナック', '大きめサイズのポークフランク。288kcal'],
            ['ジューシー粗挽きソーセージ', 150, 'ホットスナック', '粗挽き肉のジューシーソーセージ。191kcal'],
            ['炭火焼き鳥（塩）', 176, '焼き鳥', '炭火で焼いた塩味の焼き鳥。66kcal'],
            ['炭火焼き鳥（タレ）', 176, '焼き鳥', '炭火で焼いたタレ味の焼き鳥。73kcal'],
            ['スパイスチキン', 232, 'ホットスナック', 'スパイスを効かせたチキン。200kcal'],
            ['スパイスチキンレッド', 232, 'ホットスナック', '辛味スパイスを効かせたチキン。'],
        ];
